...
namespace LightOps.Commerce.Services.MetaField.Api.Services
{
    public interface IMetaFieldService
    {
        ...
        Task<IList<IMetaField>> GetByIdAsync(IList<string> ids);
        ...
        Task<IDictionary<string, IList<IMetaField>>> GetByParentIdsAsync(IList<string> parentIds);
        ...
        Task<IList<IMetaField>> GetBySearchAsync(string parentId,
                                                 string @namespace,
                                                 string name);
    }
}
